...
class ListenerSettings(BaseSettings, LoggerSettings):
    model_config = {
        "env_prefix": "KDS_SMS_SERVER_LISTENER_",
...
class WorkerSettings(BaseSettings, LoggerSettings):
    model_config = {
        "env_prefix": "KDS_SMS_SERVER_WORKER_",
        "case_sensitive": False
    }

    # worker
    worker_count: int | None = Field(default=None, title="Background Worker Count",
